...
def initializeRobotData():
    ...
    pTime = 0
    cTime = 0
    return cap,mpHands,hands,mpDraw,pTime,cTime    
def pubSub():
    ...
    return img_sub,command_publisher

def main():
    cap,mpHands,hands,mpDraw,pTime,cTime = initializeRobotData() # create an object for const data
    img_sub,command_publisher = pubSub()
